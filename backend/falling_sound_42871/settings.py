"""
Django settings for falling_sound_42871 project.
...
ROOT_URLCONF = 'falling_sound_42871.urls'
...
WSGI_APPLICATION = 'falling_sound_42871.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "falling_sound_42871 API",
    "DESCRIPTION": "API documentation for falling_sound_42871 App",
    "VERSION": "v1",
}
